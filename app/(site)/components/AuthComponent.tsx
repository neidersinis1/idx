...
className = "bg-sky-600 bg-gradient-to-b
from - sky - 900  py - 3 text - white rounded - md w - full mt - 10 hover: bg - sky - 700 transition"
    >
...
className = "w-10 h-10 bg-white rounded-full flex items-center justify-center cursor-pointer hover:opacity-80 transition"
    ...
    <FaGithub size={ 32 } />
        ...
        < p className = "text-neutral-500 mt-12 selec-none block" >
            { variant === "login"
            ? "Primera en TransAppT?"
            : "Ya tienes una cuenta?"}
<span
                onClick={ toggleVariant }
className = "text-white ml-2 hover:underline md:cursor-pointer selec-none"
    >
